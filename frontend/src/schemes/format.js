/**
 * Plain-English rendering of an eligibility condition tree, for the
 * "View eligibility" details block. Ported from schemes-legal-support/frontend.
 */
import { humanizeToken } from "./options.js";
...
export function isLeaf(node) {
  return node != null && typeof node === "object" && "field" in node;
}
